			...
			mParams.setPictureFormat(PixelFormat.JPEG);//设置拍照后存储的图片格式
			 ...
			 List<Size> mSupportedPreviewSizes;
	            ...
	            if(mSupportedPreviewSizes != null) {
	            	mPreviewSize = getOptimalPreviewSize(mSupportedPreviewSizes,CameraActivity.dm.widthPixels,CameraActivity.dm.heightPixels);
	            }
	            mParams.setPreviewSize(mPreviewSize.width, mPreviewSize.height);
	       //    params.setPreviewSize(dm.heightPixels,dm.widthPixels);
